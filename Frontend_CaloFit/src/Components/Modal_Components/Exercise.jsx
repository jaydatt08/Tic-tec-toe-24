...
const GetRequestForExercise = () =>{
  axios.get( `${url}nutrition/getuserdata`,{
    headers:{
...
const PostRequestForExercise = (data) =>{
 ...
 object.excercise_done.push(data)
  ...
  return axios.post( `${url}nutrition/add`,object,
  {
    headers:{
      Authorization: `Bearer ${Token}`,
    }
...
const patchRequestForExercise = async(data) =>{
 ...
 console.log(object.excercise_done[0].excercise)
// object.excercise_done.push(data)
//  GetRequestForExercise()
 ...
 axios.patch( `${url}nutrition/update`,object, 
  {
